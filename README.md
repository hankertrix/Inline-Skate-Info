...
Other than the `/qr_code` command in inline mode, all other commands do not collect any information or send any data about you to anyone. To reiterate, if you're uncomfortable with the developer being able to see the QR code generated by using the `/qr_code` command in inline mode, please do not use the `/qr_code` command in inline mode.
...
A massive thank you to Michelle for her help with the icons and also with the gathering of all the slalom trick videos. This project would have taken much longer to complete without her help. Thank you to Ron and Aden too for answering all of my questions on slides and slalom tricks respectively. Lastly, thank you to another Michelle for her input about the colours associated with inline skating, as the light and dark theme of the website is based on her colour suggestions.