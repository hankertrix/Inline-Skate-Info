...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `     ${$$result.head += `<!-- HEAD_svelte-28n0w_START -->${$$result.title = `<title>${escape(title)} - Inline Skate Info</title>`, ""}<meta name="description" content="The landing page for all of the pages containing resources"><!-- HEAD_svelte-28n0w_END -->`, ""}  <div class="page-wrapper svelte-14m2exm"><header class="svelte-14m2exm"><h1 class="text svelte-14m2exm"${add_attribute("id", urlFriendlyTitle, 0)}>${escape(title)}</h1> <div class="text" data-svelte-h="svelte-kz10ev">Click on one of the links below to view the respective resource!</div></header> <main class="links-grid svelte-14m2exm"> ${each(pagesWithResources, (page) => {
