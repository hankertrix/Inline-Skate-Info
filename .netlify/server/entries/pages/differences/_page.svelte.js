...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `     ${$$result.head += `<!-- HEAD_svelte-vj8r36_START -->${$$result.title = `<title>${escape(title)} - Inline Skate Info</title>`, ""}<meta name="description" content="The landing page for all of the pages talking about differences"><!-- HEAD_svelte-vj8r36_END -->`, ""}  <div class="page-wrapper svelte-cxeu0v"><header class="svelte-cxeu0v"><h1 class="text svelte-cxeu0v"${add_attribute("id", urlFriendlyTitle, 0)}>${escape(title)}</h1> <div class="text" data-svelte-h="svelte-1bpu1c">Click on one of the links below to view the page talking about the respective differences!</div></header> <main class="links-grid svelte-cxeu0v"> ${each(pagesWithDifferences, (page) => {
