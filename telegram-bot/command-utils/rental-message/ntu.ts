...
const RENTAL_MSG = `
{time}
Add your name if you want skate rentals. $5 for the whole session, which also includes the rental for guards. Please PayNow the $5 to ${process.env.NTU_TREASURER} or you can scan the QR code above. Press the ${RENTAL_MSG_CONFIG.tagString} button to indicate that you have paid. First come first served basis!!!
`.trim();
