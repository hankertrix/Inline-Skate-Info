...
export const regex = new RegExp(
	String.raw`^\/?\btricks?\b(?:${utils.regexEscape(BOT_USERNAME)})?`,
	"i",
);
...
export const TRICK_FILEPATH_MAP = {
  ...
  -------------*/
	...
	"slalom/class-A/jumps": [
		"class a slalom jumps",
		"Jumps, class A slalom tricks, category",
		null,
	],
	"slalom/class-A/others": [
		"class a slalom others",
		"Others, class A slalom tricks",
		null,
	],
	"slalom/class-A/sitting": [
		"class a slalom sitting",
		"Sitting, class A slalom tricks",
		null,
	],
	"slalom/class-A/spins": [
		"class a slalom spins",
		"Spins, class A slalom tricks",
		null,
	],
	"slalom/class-A/wheelings": [
		"class a slalom wheelings",
		"Wheelings, class A slalom tricks",
		null,
	],
	"slalom/class-B/": ["class b slalom", "Class B slalom tricks", null],
	"slalom/class-B/jumps": [
		"class b slalom jumps",
		"Jumps, class B slalom tricks",
		null,
	],
	"slalom/class-B/others": [
		"class b slalom others",
		"Others, class B slalom tricks",
		null,
	],
	"slalom/class-B/sitting": [
		"class b slalom sitting",
		"Sitting, class B slalom tricks",
		null,
	],
	"slalom/class-B/spins": [
		"class b slalom spins",
		"Spins, class B slalom tricks",
		null,
	],
	"slalom/class-B/wheelings": [
		"class b slalom wheelings",
		"Wheelings, class B slalom tricks",
		null,
	],
	"slalom/class-C/": ["class c slalom", "Class C slalom tricks", null],
	"slalom/class-C/jumps": [
		"class c slalom jumps",
		"Jumps, class C slalom tricks",
		null,
	],
	"slalom/class-C/others": [
		"class c slalom others",
		"Others, class C slalom tricks",
		null,
	],
	"slalom/class-C/sitting": [
		"class c slalom sitting",
		"Sitting, class C slalom tricks",
		null,
	],
	"slalom/class-C/spins": [
		"class c slalom spins",
		"Spins, class C slalom tricks",
		null,
	],
	"slalom/class-C/wheelings": [
		"class c slalom wheelings",
		"Wheelings, class C slalom tricks",
		null,
	],
	"slalom/class-D/": ["class d slalom", "Class D slalom tricks", null],
	"slalom/class-D/jumps": [
		"class d slalom jumps",
		"Jumps, class D slalom tricks",
		null,
	],
	"slalom/class-D/others": [
		"class d slalom others",
		"Others, class D slalom tricks",
		null,
	],
	"slalom/class-D/sitting": [
		"class d slalom sitting",
		"Sitting, class D slalom tricks",
		null,
	],
	"slalom/class-D/spins": [
		"class d slalom spins",
		"Spins, class D slalom tricks",
		null,
	],
	"slalom/class-D/wheelings": [
		"class d slalom wheelings",
		"Wheelings, class D slalom tricks",
		null,
	],
	"slalom/class-E/": ["class e slalom", "Class E slalom tricks", null],
	"slalom/class-E/jumps": [
		"class e slalom jumps",
		"Jumps, class E slalom tricks",
		null,
	],
	"slalom/class-E/others": [
		"class e slalom others",
		"Others, class E slalom tricks",
		null,
	],
	"slalom/class-E/sitting": [
		"class e slalom sitting",
		"Sitting, class E slalom tricks",
		null,
	],
	"slalom/class-E/spins": [
		"class e slalom spins",
		"Spins, class E slalom tricks",
		null,
	],
	"slalom/class-E/wheelings": [
		"class e slalom wheelings",
		"Wheelings, class E slalom tricks",
		null,
	],
	...
	"slides/class-A/family-1": [
		"class a family 1 slides",
		"Class A, family 1 slides",
		null,
	],
	"slides/class-A/family-2": [
		"class a family 2 slides",
		"Class A, family 2 slides",
		null,
	],
	"slides/class-A/family-3": [
		"class a family 3 slides",
		"Class A, family 3 slides",
		null,
	],
	"slides/class-A/family-4": [
		"class a family 4 slides",
		"Class A, family 4 slides",
		null,
	],
	"slides/class-A/family-5": [
		"class a family 5 slides",
		"Class A, family 5 slides",
		null,
	],
	"slides/class-B/": ["class b slides", "Class B slides", null],
	"slides/class-B/family-1": [
		"class b family 1 slides",
		"Class B, family 1 slides",
		null,
	],
	"slides/class-B/family-2": [
		"class b family 2 slides",
		"Class B, family 2 slides",
		null,
	],
	"slides/class-B/family-3": [
		"class b family 3 slides",
		"Class B, family 3 slides",
		null,
	],
	"slides/class-B/family-4": [
		"class b family 4 slides",
		"Class B, family 4 slides",
		null,
	],
	"slides/class-B/family-5": [
		"class b family 5 slides",
		"Class B, family 5 slides",
		null,
	],
	"slides/class-C/": ["class c slides", "Class C slides", null],
	"slides/class-C/family-1": [
		"class c family 1 slides",
		"Class C, family 1 slides",
		null,
	],
	"slides/class-C/family-2": [
		"class c family 2 slides",
		"Class C, family 2 slides",
		null,
	],
	"slides/class-C/family-4": [
		"class c family 4 slides",
		"Class C, family 4 slides",
		null,
	],
	"slides/class-C/family-5": [
		"class c family 5 slides",
		"Class C, family 5 slides",
		null,
	],
	"slides/class-D/": ["class d slides", "Class D slides", null],
	"slides/class-D/family-1": [
		"class d family 1 slides",
		"Class D, family 1 slides",
		null,
	],
	"slides/class-D/family-2": [
		"class d family 2 slides",
		"Class D, family 2 slides",
		null,
	],
	"slides/class-D/family-4": [
		"class d family 4 slides",
		"Class D, family 4 slides",
		null,
	],
	"slides/class-D/family-5": [
		"class d family 5 slides",
		"Class D, family 5 slides",
		null,
	],
	"slides/class-E/": ["class e slides", "Class E slides", null],
	"slides/class-E/family-1": [
		"class e family 1 slides",
		"Class E, family 1 slides",
		null,
	],
	"slides/class-E/family-2": [
		"class e family 2 slides",
		"Class E, family 2 slides",
		null,
	],
	"slides/class-E/family-4": [
		"class e family 4 slides",
		"Class E, family 4 slides",
		null,
	],
} as const;
...
async function loadTricksJson(file: string) {
	...
	const [, , loadFunction] = utils.dictGet(TRICK_FILEPATH_MAP, file, [
		null,
		null,
		null,
...
function generateTrickText(
	trickName: string,
	trickObj: TrickObj,
	noHeading: boolean = false,
) {
	...
	for (const [label, value] of Object.entries(trickObj)) {
		...
		if (Array.isArray(value)) {
			...
			// Gets the heading
			const heading = utils.bold(`${utils.titlecase(label)}:`);
			...
			if (value.length === 1) {
				...
				textList.push(
					`${newHeading} ${utils.hyperlink(channelName, link)}`,
				);
			}
			...
			// Otherwise, adds all the channel names hyperlinked with the video link to the text list
				...
				textList.push(
					`${heading}\n${value
						.map(
							([channelName, link], index) =>
								`${index + 1}. ${utils.hyperlink(channelName, link)}`,
						)
						.join("\n")}`,
				);
		}
		...
		// Otherwise, add the bolded label with the information behind it if the value isn't empty
			...
			textList.push(`${utils.bold(`${label}:`)} ${value}`);
		}
	}
...
async function getTrickText(jsonFiles: string[], trick: string = "") {
	...
	const jsons = (await Promise.all(
		jsonFiles.map(file => loadTricksJson(file)),
	)) as {
	...
	for (const json of jsons) {
		...
		if (trick) {
			trickTextList.push(generateTrickText(trick, json[trick], true));
		}
		...
		// Otherwise, generates the text for each trick in the file and add it to the text list
			...
			for (const [trickName, trickObj] of Object.entries(json)) {
				...
				generatedText.push(generateTrickText(trickName, trickObj));
			}
...
export async function handler(message: string) {
	...
	// Otherwise, if the message is some other word
		...
		// Otherwise
			...
			heading = (
				utils.dictGet(TRICK_FILEPATH_MAP, jsonFile, [
					"Category not found",
					"Trick heading not found",
					null,
				]) as [string, string, () => Promise<Dict<string>>]
			)[1];
		}
	}
