// Module to handle the buying guide command
...
// Function to generate the guides message
export function generateGuides(heading: string, links: string[], files: string[]) {

  // The message
  const message = `${utils.bold(heading)}${SPACING}${links.join("\n\n")}`;
