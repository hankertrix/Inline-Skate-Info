<!-- The page for all of the class E slalom tricks -->
...
<!-- The HTML for all of the class E slalom tricks -->
<TricksPage title="Class E Slalom Tricks" {tricksJson} headingLevel={2} changeInHeadingLevel={1} />