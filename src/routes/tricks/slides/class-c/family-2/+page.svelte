...
<!-- The HTML for the class C family 2 slides -->
<TricksPage title="Class C, Family 2 Slides" description="The list of class C slides in family 2" {tricksJson} headingLevel={3} changeInHeadingLevel={1} />