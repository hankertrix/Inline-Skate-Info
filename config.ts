// Module that contains all the configuration for the bot
...
// The setting to enable deleting command messages in group chats for the poll and training message commands
export const ENABLE_DELETING_COMMAND_MESSAGES = true;
